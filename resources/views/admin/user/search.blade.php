        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $filters['first_name'] ? $filters['first_name'] : '' }}"
                        name="first_name" class="form-control" placeholder="{{ __('First Name') }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
                    <label class="form-label">{{ __('Last Name') }}</label>
                    <input type="text" value="{{ $filters['last_name'] ? $filters['last_name'] : '' }}"
                        name="last_name" class="form-control" placeholder="{{ __('Last Name') }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
